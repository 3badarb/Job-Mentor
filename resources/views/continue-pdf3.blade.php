                                            ...
                                            <div class="tab-content"
                                                ...
                                                <div class="tab-pane fade show
                                                    ...
                                                    aria-labelledby="settings-tab">
                                                        ...
                                                        mt-4">
                                                                <p class="fs-17
                                                            mb-0 ">We almost finish we just want you to select the years of yours experience in this job title if you don't have, choose 0</p>


                                                            </div>
                                                            <div class='container mt-5'>
                                                                <form method="post" action="/storemodel2pdf">
                                                                    <label for="yoe"></label>
                                                                    <select class="form-select form-select-sm" name="yoe" id="yoe" aria-label=".form-select-sm example" required>
