                                                ...
                                                <div class="tab-pane fade show
                                                    ...
                                                    aria-labelledby="settings-tab">
                                                        ...
                                                        <div>
                                                            <h4 class="
                                                                fw-semibold mb-3
                                                                mb-0"><p>According to our AI we extract these infos from your cv <br>
                                                            if there is any missing data please write it and press save
                                                            <br>
                                                                    or press next</p></h4>
                                                            @if($errors->any())
                                                                ...
                                                                @endforeach
                                                            @endif
                                                            <form method="get" id="2" action="/continue-pdf2">
                                                                <div class="mt-4
                                                            text-end">
                                                        ...
                                                        @csrf
                                                    <form method="post" action="/update-pdf-info" enctype="multipart/form-data">
                                                        <div class="mt-4">
                                                            <h5 class="fs-17
                                                                fw-semibold
                                                                mb-3">EDUCATION</h5>
